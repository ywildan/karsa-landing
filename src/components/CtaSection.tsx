    ...
    <section className="relative bg-[#FAFAFA] py-28 sm:py-36 border-b border-zinc-200/60 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        >
          ...
          UNTIDAR • ACADEMIC YEAR 2026/2027
        </motion.div>
        ...
        >
          Built for Universitas Tidar.
          <br />
          <span className="italic font-normal text-zinc-800">Launching soon.</span>
        </motion.h2>
        ...
        >
          Sign in to preview the current build.
        </motion.p>
        ...
        >
          ...
          <span>Only @students.untidar.ac.id</span>
        </motion.div>
